...
<ul style="font-size: 0.9em; line-height: 1.45; margin-top: 0;">
  <li><strong>[Now]</strong> I am working on Vision-and-Language Navigation, where I fine-tune vision-language models to predict navigable goal pixels for embodied navigation (most recent works predict actions).</li>
